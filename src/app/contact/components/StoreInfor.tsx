  ...
  return (
    <div className="contact-info py-3">
      ...
      <div className="mb-4 fs-6 shadow-none">
        ...
        <p className="mb-2 fw-bold text-uppercase">Su: CLOSED</p>
      </div>

      {/* 3. Đoạn văn mô tả */}
      <p className="text-secondary mb-5 lh-lg fs-7" style={{ maxWidth: '90%' }}>
        Nam eu mi eget velit vulputate tempor gravida quis massa. In malesuada condimentum ultrices.
        Sed et mauris a purus fermentum elementum. Sed tristique semper enim, et gravida orci
        iaculis et. Nulla facilisi.
      </p>
      ...
      <div className="social-section">
        ...
        <div className="d-flex gap-2">
          ...
          <a
            href="#"
            className="btn p-0 rounded-circle d-flex align-items-center justify-content-center text-white"
